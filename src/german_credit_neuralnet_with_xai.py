...
xpl_lime_neuralnet.features_imp.to_csv("../data/output/lime/lime_neuralnet_all.csv")

xpl_shap_neuralnet.features_imp.to_csv("../data/output/shap/shap_neuralnet_all.csv")
